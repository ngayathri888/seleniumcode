...
public class FileUploadUsingAutoit {
    ...
    @Test
    public void easyUploadTest(@Optional("chrome") String browser) throws InterruptedException, IOException {
        ...
        if(browser.equalsIgnoreCase("chrome")){
            Runtime.getRuntime().exec("C:\\autoitscripts\\chromescript.exe");
        }else if(browser.equalsIgnoreCase("firefox")){
            Runtime.getRuntime().exec("C:\\autoitscripts\\firefoxscript.exe");
